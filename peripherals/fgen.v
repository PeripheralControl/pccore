...
//  is modified and sent directly to the 8 output pin for triangle and square
//  wave outputs.
//
//  Registers:
...
module fgen(CLK_I,WE_I,TGA_I,STB_I,ADR_I,STALL_O,ACK_O,DAT_I,DAT_O,clocks,pins);
    ...
    inout  [7:0] pins;       // Simple binary output
    ...
    // Assign the outputs.  Output expects an R-2R DAC or equivalent
    assign pins = 
